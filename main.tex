...
\title{FreeWill: A Recursive Proof of ...}   % <— adjust as you like
\author{Sean Haupt et al.}
\date{\today}
% ---------- end preamble ----------
...
% Paste or type everything that used to be in text28.txt,
% but use LaTeX markup for sections, equations, etc.

This is a quick paragraph to prove the pipeline works.

\begin{figure}[ht]
  \centering
  \includegraphics[width=\linewidth]{figure1_flip_rate_vs_noise.png}
  \caption{Flip-rate performance over 10 k iterations.}
\end{figure}
